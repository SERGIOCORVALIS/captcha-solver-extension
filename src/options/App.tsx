...
const OptionsApp: React.FC = () => {
  ...
  if (!config) {
    return <div className="options-container">Failed to load configuration</div>;
  }
      ...
      {activeTab === 'captcha' && (
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              updateConfig({
                captchaTypes: { ...config.captchaTypes, recaptchaV2: e.target.checked },
              })
            }
          />
          reCAPTCHA v2
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              updateConfig({
                captchaTypes: { ...config.captchaTypes, recaptchaV3: e.target.checked },
              })
            }
          />
          reCAPTCHA v3
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              updateConfig({
                captchaTypes: { ...config.captchaTypes, hcaptcha: e.target.checked },
              })
            }
          />
          hCaptcha
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              updateConfig({
                captchaTypes: { ...config.captchaTypes, turnstile: e.target.checked },
              })
            }
          />
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              updateConfig({
                captchaTypes: { ...config.captchaTypes, imageCaptcha: e.target.checked },
              })
            }
          />
          Image CAPTCHA
      ...
      {activeTab === 'api' && (
        ...
        <label>
          ...
          <select
            ...
            onChange={(e) =>
              updateConfig({
                apiConfig: { ...config.apiConfig, provider: e.target.value as ApiProvider },
              })
            }
          >
        ...
        <label>
          ...
          />
          {errors.apiKey && (
            <span style={{ color: 'red', fontSize: '12px' }}>{errors.apiKey}</span>
          )}
        </label>
        {config.apiConfig.provider === 'custom' && (
          <label>
            ...
            />
            {errors.endpoint && (
              <span style={{ color: 'red', fontSize: '12px' }}>{errors.endpoint}</span>
            )}
          </label>
        )}
      </div>
      ...
      {activeTab === 'advanced' && (
        ...
        <label>
          ...
          <input
            ...
            onChange={(e) =>
              updateConfig({
                advanced: { ...config.advanced, clickDelay: parseInt(e.target.value) || 500 },
              })
            }
            min="0"
          />
        ...
        <label>
          ...
          <input
            ...
            onChange={(e) =>
              updateConfig({
                advanced: { ...config.advanced, solveDelay: parseInt(e.target.value) || 1000 },
              })
            }
            min="0"
          />
        ...
        <label>
          ...
          <input
            ...
            onChange={(e) =>
              updateConfig({
                advanced: { ...config.advanced, retryAttempts: parseInt(e.target.value) || 3 },
              })
            }
            min="0"
          />
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              updateConfig({
                advanced: { ...config.advanced, enableLogging: e.target.checked },
              })
            }
          />
          Enable logging
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              updateConfig({
                advanced: { ...config.advanced, mouseMovement: e.target.checked },
              })
            }
          />
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              updateConfig({
                advanced: { ...config.advanced, humanLikeBehavior: e.target.checked },
              })
            }
          />
          Human-like behavior
